...
return [
    ...
    'custom'               => [
        'domain' => [
            'url'=>'Некорректный адрес сайта для мониторинга',
            'required'=>'Укажите адрес сайта для мониторинга',
        ],
        'chat_id'=>[
            'exists'=>'Укажите подтвержденную беседу Telegram'
        ],
        'page_select_type'=>[
            'required'=>'Выберите один из двух типов указания страниц для сайта'
        ],
        'sitemap_url'=>[
            'url'=>'Некорректный адрес карты сайта'
        ],

    ],
//    'telegram_chat_id'=>'',
//    'manual_input_text_area' => 'Неверный формат записи страниц сайта',
