    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <x-view-data-table table-type="performanceReports" :rowsData="$rowsData"
...
<script>
    $(function () {
        document.dataTable = new SortingDataTable('performanceReports', {{$totalPageCount}});
        document.dataTable.initHandlers();
        $('body').on('click', '.performance-report', function (e) {
            let id = $(this).data('report-id');
            if (id) {
                $.ajax(
                    {
                        url: `/user-control-panel/performance-reports/${id}/`,
                        method: 'get',
                        headers: {
